...
/**
 * Neubrutalism Drawer - Bold borders with playful styling
 */
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        "bg-white border-2 border-b-0 border-black shadow-[0_-4px_0_black]",
        "dark:bg-gray-900 dark:border-white dark:shadow-[0_-4px_0_white]",
        className,
      )}
      {...props}
    >
