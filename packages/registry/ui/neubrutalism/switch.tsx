...
/**
 * Neubrutalism Switch - Bold borders, hard shadows
 */
...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-yellow-400 data-[state=unchecked]:bg-gray-200",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-4 w-4 rounded-full bg-black shadow-lg ring-0",
