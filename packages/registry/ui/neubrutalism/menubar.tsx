...
/**
 * Neubrutalism Menubar - Bold borders with playful styling
 */
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Label
    ...
    className={cn(
      "px-2 py-1.5 text-sm font-black uppercase",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator
    ...
    className={cn("-mx-1 my-1 h-px bg-black dark:bg-white", className)}
    {...props}
  />
));
